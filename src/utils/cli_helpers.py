...
def get_adaptive_speaker_settings():
    ...
    try:
        ...
        if choice == '1':
            ...
            _bulk_save(enable_adaptive_speaker_thresholds=new_enabled)
            ...
            try:
                ...
                if 0.1 <= new_threshold <= 0.9:
                    _bulk_save(base_speaker_similarity_threshold=new_threshold)
            ...
            try:
                ...
                if 0.0 <= new_boost <= 0.5:
                    _bulk_save(single_speaker_similarity_boost=new_boost)
            ...
            _bulk_save(
                enable_adaptive_speaker_thresholds=True,
                base_speaker_similarity_threshold=0.65,
                single_speaker_similarity_boost=0.25,
                single_speaker_clustering_boost=0.15
            )
